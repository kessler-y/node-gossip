...
function Gossiper (port, seeds, address, emitUpdateOnHeartBeat) {
...
Gossiper.prototype._connect = function (peer) {
...
Gossiper.prototype._send = function (socket, msg) {
  if (debug.enabled) {    
    debug('sending message %s', util.inspect(msg))
  }

  socket.write(msg)
}

Gossiper.prototype._disconnect = function (socket) {
